describe('koappcalculator controller', function() {
  beforeEach(function() {
    browser.driver.manage().window().setSize(400, 666);
    browser.get('http://localhost:9001/#/menu-abcd/koappcalculator');
  });

  it('should load module', function() {
    expect(element(by.css('.koappcalculator'))).toBeDefined();
  });
